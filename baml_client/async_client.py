...
class BamlAsyncClient:
    ...
    async def GetResponse(self, chat_history: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="GetResponse", args={
                "chat_history": chat_history,
            })
            return typing.cast(types.Response, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def GetResponse2(self, chat_history: str,
        baml_options: BamlCallOptions = {},
    ) -> types.Response2:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="GetResponse2", args={
                "chat_history": chat_history,
            })
...
class BamlStreamClient:
    ...
    def GetResponse(self, chat_history: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="GetResponse", args={
            "chat_history": chat_history,
        })
    ...
    def GetResponse2(self, chat_history: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Response2, types.Response2]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="GetResponse2", args={
            "chat_history": chat_history,
        })
        return baml_py.BamlStream[stream_types.Response2, types.Response2](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def GetResponse(self, chat_history: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="GetResponse", args={
            "chat_history": chat_history,
        }, mode="request")
        return __result__
    async def GetResponse2(self, chat_history: str,
